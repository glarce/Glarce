...
class Res
{
  ...
  {
    if (this.type != 'video') console.error(chalk.bold.red(`${this.key}: Interactivity is only available to video. You can set it to a video by using ${chalk.cyan('res.type(\'video\')')}`))
